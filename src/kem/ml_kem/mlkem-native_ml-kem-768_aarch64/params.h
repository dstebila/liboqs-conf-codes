...
// #define MLKEM_INDCPA_CONFIRMATION_CODE_FULL
#define MLKEM_INDCPA_CONFIRMATION_CODE_TWO_COEFFS
#ifdef MLKEM_INDCPA_CONFIRMATION_CODE_FULL
#define MLKEM_INDCPA_CODEBYTES (MLKEM_POLYVECBYTES + MLKEM_POLYBYTES)
#elif defined(MLKEM_INDCPA_CONFIRMATION_CODE_TWO_COEFFS)
#define MLKEM_INDCPA_CODEBYTES ((MLKEM_K + 1) * 2 * sizeof(int16_t))
#endif
