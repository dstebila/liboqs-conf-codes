 ...
 */
void PQCLEAN_HQC128_CLEAN_hqc_pke_encrypt(uint64_t *u, uint64_t *v, uint8_t *cd, uint8_t *m, uint8_t *theta, const uint8_t *pk) {
    ...
    cd[0] = (s_times_r2_plus_e[VEC_N_SIZE_64 - 1]) & 0xFF;
}
